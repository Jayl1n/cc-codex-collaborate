...
echo "- Place mixed discussion notes in docs/cccc/inbox/"
echo "- Run /cccc sync-inbox to discover new documents"
echo "- Run /cccc curate-docs to extract engineering facts"
